...
<question_label>**Câu 4.**</question_label> <stem>Cho hàm số $f(x)$ có bảng biến thiên như sau:
...
Giá trị cực đại của hàm số đã cho bằng</stem>

- <option_label>**A.**</option_label> <option_text>3.</option_text>
- <option_label>**B.**</option_label> <option_text>$-2$.</option_text>
- <option_label>**C.**</option_label> <option_text>$-1$.</option_text>
- <option_label>**D.**</option_label> <option_text>2.</option_text>

<question_label>**Câu 10.**</question_label> <stem>Cho hình chóp $S.ABC$ có đáy $ABC$ là tam giác vuông tại $B$. Cạnh bên $SA$ vuông góc với mặt phẳng đáy _(tham khảo hình vẽ)_. Biết $SA=AB=4a, BC=3a$. Thể tích của khối chóp $S.ABC$ là
