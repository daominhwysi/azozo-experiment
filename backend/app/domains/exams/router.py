...
from backend.app.domains.exams.models import CreateExamRequest, StudentSubmissionRequest
...
from backend.app.core.config import TMP_DIR, OCR_MODEL, OCR_BATCH_SIZE, OCR_CONCURRENCY, ANSWER_MAPPER_MODEL, ANSWER_MAPPER_PROVIDER
