...
from backend.app.domains.ocr.parser.long_parser.source_merger.types import GlobalSpan, ChunkInput
from backend.app.domains.ocr.parser.long_parser.source_merger.canonical_source import PiecewiseMap
from backend.app.domains.ocr.parser.long_parser.source_merger.xml_lexer import LocalSpan
