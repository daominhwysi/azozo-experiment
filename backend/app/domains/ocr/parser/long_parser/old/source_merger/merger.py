...
from backend.app.domains.ocr.parser.long_parser.source_merger.canonical_source import build_canonical_source
from backend.app.domains.ocr.parser.long_parser.source_merger.xml_lexer import lex_annotations
from backend.app.domains.ocr.parser.long_parser.source_merger.source_aligner import SourceAligner
from backend.app.domains.ocr.parser.long_parser.source_merger.span_projector import project_local_spans_to_global
from backend.app.domains.ocr.parser.long_parser.source_merger.reconciler import reconcile_candidates
from backend.app.domains.ocr.parser.long_parser.source_merger.serializer_validator import (
