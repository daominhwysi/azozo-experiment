...
<question_label>**102.**</question_label> <stem>------ employees are requested to submit a secondary contact number and email address.</stem>
- <option_label>(A)</option_label> <option_text>Every</option_text>
- <option_label>(B)</option_label> <option_text>All</option_text>
- <option_label>(C)</option_label> <option_text>Each</option_text>
- <option_label>(D)</option_label> <option_text>Any</option_text>
...
<question_label>145.</question_label>
<option_label>(A)</option_label> <option_text>after all</option_text>
<option_label>(B)</option_label> <option_text>again</option_text>
<option_label>(C)</option_label> <option_text>as well</option_text>
<option_label>(D)</option_label> <option_text>since</option_text>


<question_label>177.</question_label> <stem>In the Web page, the word "delivers" in paragraph 1, line 4, is closest in meaning to</stem>
...
<question_label>178.</question_label> <stem>What is true about Dr. Aris?</stem>
   <option_label>(A)</option_label> <option_text>He is a certified medical director.</option_text>
   <option_label>(B)</option_label> <option_text>He received a 20 percent rebate on annual equipment repairs.</option_text>
   <option_label>(C)</option_label> <option_text>He receives wellness advice from a digital newsletter.</option_text>
   <option_label>(D)</option_label> <option_text>He attends weekly seminars at Apex University.</option_text>
