...
HTML_VOID_TAGS: Set[str] = {"br", "hr", "img", "col", "wbr", "input"}
...
class XMLChecker:
    ...
    def check(
        ...
        # 4. Check for unclosed tags remaining in stack
        while tag_stack:
        ...
        # Document is invalid if it has mismatched tags, unclosed tags, unexpected closing tags, truncated tags, or fatal prohibited tags
        is_valid = not (
            has_mismatched_tags
