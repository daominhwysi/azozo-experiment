# 📄 Annotated Document & Chunk Boundaries: Micro Target (2.5k Tokens)
**Target Tokens:** `2,500` | **Max Tokens:** `4,000` | **Total Chunks:** `5`  
---

```text
================================================================================
🚀 CHUNK 1 START | Range: p1-p8 (8 pages) | Tokens: 2,682
   Head Flag: CLEAN | Tail Flag: CLEAN
================================================================================
```

### Page 1 (Est. Tokens: 50, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
# 기출 TEST 10
```

### Page 2 (Est. Tokens: 483, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
**READING TEST**
...
### Page 3 (Est. Tokens: 483, Head: `CONT_GROUP`, Tail: `CLEAN`)
```markdown
...
### Page 4 (Est. Tokens: 407, Head: `CONT_GROUP`, Tail: `CLEAN`)
```markdown
...
**128.** The leadership team was quite relieved ------ the Toyvar building project was completed under budget.
(A) especially
(B) following
(C) when
(D) than
...
### Page 5 (Est. Tokens: 320, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
## PART 6
...
>
> RGBS Automotive is ------ hiring full-time and part-time workers. Apply today! ------ could become part of our manufacturing team! We make high-tech products ------ found in cars and trucks of all kinds.
>
> RGBS Automotive pays well, and we provide ongoing training plus opportunities for promotion.
>
> ------ . Go to www.rgbsautomotive.com for more details and to fill out an application.
...
### Page 6 (Est. Tokens: 323, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
>
> Thank you again to all of you for your fine work on the upcoming marketing campaign for the Turbo Omega 2 smartphone. As ------ during yesterday's meeting, our goal is to launch the television, radio, and social media advertisements on 1 November. The phone itself will be in stores by 1 December. ------ .
>
> ------ , Gary Carollo will draft the press release and post it on our shared drive, where all of you will be able to read it. Please e-mail any ------ for changes to Gary within one week. He will present his final draft at our next regular meeting. We will also tie up any loose ends at that time.
...
### Page 7 (Est. Tokens: 315, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
**Questions 139-142** refer to the following product information.

> **Handmade Silk Blouse by Coreopsis Textiles, Size Medium, £45**
>
> Coreopsis Textiles' silk blouses are created from vintage fabrics and other recycled components that we sew together in a patchwork fashion. Because all 139. ______ garments are handcrafted, each is one of a kind. 140. ______. Unique variations within each piece are part of the charm of Coreopsis Textiles' products. The blouse you receive will be similar in style but not identical to the one pictured.
>
> Please note that this garment is 141. ______. It is recommended that you either hand-wash it or wash it in cold water on the gentle cycle in a mesh bag. While the item has been prewashed, dryer heat may cause it to shrink. 142. ______, it is important that it be hung to air dry.
...
### Page 8 (Est. Tokens: 301, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
> Dear Ms. Jiang,
>
> We are pleased you 143. ______ Maple Road Storage for your storage needs. I have attached a copy of your signed contract. 144. ______.
>
> Do you know about our referral program? You will receive one free month of storage if someone you recommend signs a contract with us. The new tenant will receive a free month 145. ______. You can find more information about this program and all our special 146. ______ on our Web site at www.mapleroadstorage.ca.
>
> Sincerely,
>
...
```text
┌──────────────────────────────────────────────────────────────────────────────┐
│ ✂️ CHUNK BOUNDARY (Chunk 1 ➔ Chunk 2)                                        │
│ End Chunk 1: p1-p8 (2,682 tokens) | Tail: CLEAN                              │
│ Start Chunk 2: p8-p15 (2,704 tokens) | Head: CLEAN                           │
└──────────────────────────────────────────────────────────────────────────────┘
```

```text
================================================================================
🚀 CHUNK 2 START | Range: p8-p15 (8 pages) | Tokens: 2,704
   Head Flag: CLEAN | Tail Flag: CLEAN
================================================================================
```
...
### Page 9 (Est. Tokens: 365, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
# PART 7
...
### Page 10 (Est. Tokens: 227, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 11 (Est. Tokens: 405, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 12 (Est. Tokens: 375, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 13 (Est. Tokens: 419, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 14 (Est. Tokens: 319, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 15 (Est. Tokens: 293, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
```text
┌──────────────────────────────────────────────────────────────────────────────┐
│ ✂️ CHUNK BOUNDARY (Chunk 2 ➔ Chunk 3)                                        │
│ End Chunk 2: p8-p15 (2,704 tokens) | Tail: CLEAN                             │
│ Start Chunk 3: p15-p20 (2,580 tokens) | Head: CLEAN                          │
└──────────────────────────────────────────────────────────────────────────────┘
```

```text
================================================================================
🚀 CHUNK 3 START | Range: p15-p20 (6 pages) | Tokens: 2,580
   Head Flag: CLEAN | Tail Flag: CLEAN
================================================================================
```
...
### Page 16 (Est. Tokens: 531, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
> Dear Bruce,
>
> Beginning with the new fiscal year, a change in retirement benefits will be applied for all full-time employees here in Blanen Industries. They will no longer be given their matching retirement funds in the form of cash. Instead, their retirement funds will be provided in the form of company stock to be deposited in their retirement portfolios.
>
...
### Page 17 (Est. Tokens: 597, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 18 (Est. Tokens: 382, Head: `CLEAN`, Tail: `OPEN_STEM`)
```markdown
...
### Page 19 (Est. Tokens: 242, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 20 (Est. Tokens: 535, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
```text
┌──────────────────────────────────────────────────────────────────────────────┐
│ ✂️ CHUNK BOUNDARY (Chunk 3 ➔ Chunk 4)                                        │
│ End Chunk 3: p15-p20 (2,580 tokens) | Tail: CLEAN                            │
│ Start Chunk 4: p20-p25 (2,576 tokens) | Head: CLEAN                          │
└──────────────────────────────────────────────────────────────────────────────┘
```

```text
================================================================================
🚀 CHUNK 4 START | Range: p20-p25 (6 pages) | Tokens: 2,576
   Head Flag: CLEAN | Tail Flag: CLEAN
================================================================================
```
...
### Page 21 (Est. Tokens: 288, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 22 (Est. Tokens: 540, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
> Dear Lisa,
>
> Thank you for sending your invoice for services rendered in the month of September. I want to commend you on your superb start as one of our independent freelance editors. Our clients have nothing but positive things to say about your work. As you know, we do not dictate how you structure your workday; instead, Brit-Revision (BRV) guidelines require simply that deadlines be met and that work quality be maintained. You have done both admirably.
>
...
### Page 23 (Est. Tokens: 229, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 24 (Est. Tokens: 549, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
...
### Page 25 (Est. Tokens: 435, Head: `CLEAN`, Tail: `CLEAN`)
```markdown
| | |
|---|---|
...
```text
┌──────────────────────────────────────────────────────────────────────────────┐
│ ✂️ CHUNK BOUNDARY (Chunk 4 ➔ Chunk 5)                                        │
│ End Chunk 4: p20-p25 (2,576 tokens) | Tail: CLEAN                            │
│ Start Chunk 5: p25-p29 (2,355 tokens) | Head: CLEAN                          │
└──────────────────────────────────────────────────────────────────────────────┘
```

```text
================================================================================
🚀 CHUNK 5 START | Range: p25-p29 (5 pages) | Tokens: 2,355
   Head Flag: CLEAN | Tail Flag: CLEAN
================================================================================
```
...
### Page 26 (Est. Tokens: 468, Head: `CLEAN`, Tail: `CONT_THEORY`)
```markdown
...
### Page 27 (Est. Tokens: 461, Head: `CONT_THEORY`, Tail: `CLEAN`)
```markdown
## MEMO
...
### Page 28 (Est. Tokens: 427, Head: `CLEAN`, Tail: `CONT_THEORY`)
```markdown
...
| Calle Tablas 820 | 241 Yeonhae-ro, Jung-gu |
...
### Page 29 (Est. Tokens: 564, Head: `CONT_THEORY`, Tail: `CLEAN`)
```markdown
| | |
|---|---|
