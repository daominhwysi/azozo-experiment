...
| **Chunk 2** | `p13 - p23` | `11` | `4375` | `[██████░░░░]` 67% | ✅ Yes | `None` |
| **Chunk 3** | `p23 - p29` | `7` | `3133` | `[████░░░░░░]` 48% | ✅ Yes | `None` |

**Visual Chunk Map:**
```
[Chunk 1: p1..p13] [Chunk 2: p13..p23] [Chunk 3: p23..p29]
```
...
| **Chunk 2** | `p8 - p15` | `8` | `2704` | `[██████░░░░]` 67% | ✅ Yes | `None` |
| **Chunk 3** | `p15 - p20` | `6` | `2580` | `[██████░░░░]` 64% | ✅ Yes | `None` |
| **Chunk 4** | `p20 - p25` | `6` | `2576` | `[██████░░░░]` 64% | ✅ Yes | `None` |
| **Chunk 5** | `p25 - p29` | `5` | `2355` | `[█████░░░░░]` 58% | ✅ Yes | `None` |

**Visual Chunk Map:**
```
[Chunk 1: p1..p8] [Chunk 2: p8..p15] [Chunk 3: p15..p20] [Chunk 4: p20..p25] [Chunk 5: p25..p29]
```
