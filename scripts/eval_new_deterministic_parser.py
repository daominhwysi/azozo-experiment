...
from backend.app.domains.ocr.parser.deterministic_parser import parse_chunk_deterministic as parse_new_det
from backend.app.domains.ocr.parser.long_parser.old.deterministic_parser import parse_chunk_deterministic as parse_old_det
