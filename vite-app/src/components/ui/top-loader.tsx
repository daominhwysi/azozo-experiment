...
export function TopLoader() {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute top-0 right-0 h-1 w-28 bg-gradient-to-r from-transparent to-white blur-[1px] transform translate-x-full transition-all duration-300 ease-out"
        style={{
          left: `${progress}%`,
