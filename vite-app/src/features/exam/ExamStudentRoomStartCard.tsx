              ...
              {exams.map((ex) => {
                ...
                return (
                  ...
                  <button
                    ...
                    className={cn(
                      "flex w-full items-start gap-3 rounded-lg border p-3 text-left transition-all cursor-pointer select-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none",
                      isActive
                  ...
                  >
                    ...
                    <span className="flex-1 min-w-0">
                      <span className="block text-xs font-semibold leading-snug truncate text-foreground">
                        {ex.title}
                      </span>
                    ...
                    <ChevronRight aria-hidden="true" className={cn("h-3.5 w-3.5 shrink-0 self-center text-muted-foreground/45 transition-transform", isActive && "text-primary translate-x-0.5")} />
                  </button>
                  </li>
                )
              })}
