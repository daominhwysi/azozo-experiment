          ...
          >
            ...
            <SelectContent className="bg-popover border border-border text-popover-foreground">
              ...
              <SelectItem value="correct">
                <div className="flex items-center justify-between w-full pr-1">
                  <span>Correct</span>
                  <span className="text-[10px] text-success font-bold">({counts.correct})</span>
                </div>
              </SelectItem>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 gap-2 pt-1 pl-2">
                    {res.options.map((opt) => {
                      ...
                      if (isStudentSel) {
                        if (isCorrect) {
                          optStyle = "border-transparent bg-success/5 text-success font-semibold"
                          radioBorder = "border-success bg-success/10"
                          dotColor = "bg-success"
                          badgeClass = "border-success bg-success text-success-foreground font-semibold"
                        } else {
                          ...
                          badgeClass = "border-destructive bg-destructive text-destructive-foreground font-semibold"
                        }
                      } else if (showRightAnswers && isCorrectAns) {
                        optStyle = "border-transparent bg-success/5 text-success font-medium"
                        radioBorder = "border-success/30 bg-success/5"
                        dotColor = "bg-success/30"
                        badgeClass = "border-success bg-success/70 text-success-foreground font-semibold"
                      }
                      ...
                      return (
                        ...
                        >
                          ...
                          {isStudentSel && isCorrect && (
                            <Check className="h-4 w-4 shrink-0 self-center text-success" />
                          )}
                          {isStudentSel && !isCorrect && (
