        ...
        <div
          className={
            isSingleMode
              ...
              : "fixed right-0 bottom-0 left-0 z-50 flex flex-col gap-2.5 border-t border-border bg-background px-4 py-2.5 md:px-6"
          }
        >
          {showQuestionNumbers && (
            ...
            <div className="flex shrink-0 items-center gap-2">
              <div className="flex items-center gap-1.5 rounded-lg border border-border/60 bg-muted/40 p-1">
                <Button
                  ...
                  aria-pressed={showQuestionGrid}
                  title={showQuestionGrid ? "Hide question map" : "Show question map"}
                ...
                >
                  <span aria-hidden="true" className="grid h-3.5 w-3.5 grid-cols-3 gap-0.5">
                ...
                <Button
                  ...
                  aria-pressed={showQuestionNumbers}
                  title={showQuestionNumbers ? "Hide question list" : "Show question list"}
                >
                  <span aria-hidden="true" className="flex h-3.5 w-3.5 flex-col items-center justify-center gap-0.5">
                  ...
                  ({ globalIndex: idx }) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex h-8 w-8 shrink-0 cursor-pointer flex-col items-center justify-center rounded-md border text-xs font-semibold transition-all focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring ${
                          isCorrect
